 ...
 * a loop, not a request. `AssistantChat.control` already drops an exact repeat
 * of a command within a turn, so this bounds the rest: switched on, dimmed,
 * given a colour and corrected once is four, and six leaves room.
 */
